...
Oblivious String B-tree (COSB-tree), which they argue works more efficiently
for variable length string keys. They also provide a modified front-compression
scheme, which lets their data structure use less space and have improved
